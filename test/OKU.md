...
| `konum_denetimi.py` | **Konum ölçüleri, datum ve çapraz kenarlar.** Zincir kuralı: kenardan ilk deliğe, sonra dizinin adımı (`10 x 20`), sonra son delikten öbür kenara — 124 deliğin her birine 20 mm yazılmaz. Dizinin tanınması, dağınık deliklerin **hepsinin aynı kenardan** (datumdan) ölçülmesi — zincir kurulmaması —, gabarinin **en dışarıda** kalması, 45°'lik pahın bulunup boyunun ve açısının doğru çıkması, açının makul hassasiyette yazılıp kılavuzla bağlanması ve hiçbir yazının bir başkasının ya da konturun üstüne binmemesi denetlenir. | `python test/konum_denetimi.py` |
