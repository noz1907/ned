...
| `gui_pafta_denetimi.py` | 7. adım (PAFTA) **baştan sona**: klasör seç → Listeyi tazele → Tümünü seç → PAFTAYA AL → BAS. Dosyaların gerçekten yazıldığı, paftada pencere ve resim no bulunduğu, A4/A3/A2/A1/A0'ın hepsinin çalıştığı doğrulanır. İş parçacıkları sırayla çalıştırılır, tkinter gerekmez. | `python test/gui_pafta_denetimi.py` |
