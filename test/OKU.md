...
| `konum_denetimi.py` | **Deliklerin kenardan konum ölçüleri.** Zincir kuralı: kenardan ilk deliğe, sonra dizinin adımı (`10 x 20`), sonra son delikten öbür kenara — 124 deliğin her birine 20 mm yazılmaz. Dizinin tanınması, dağınık deliklerin tek tek ölçülmesi, gabari ölçüsünün **en dışarıda** kalması ve hiçbir yazının bir başkasının ya da konturun üstüne binmemesi denetlenir. | `python test/konum_denetimi.py` |
